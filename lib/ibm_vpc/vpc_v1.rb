...
module IbmVpc
  ...
  class VpcV1 < IBMCloudSdkCore::BaseService
    ...
    ##
    # @!method replace_bare_metal_server_initialization(id:, image:, keys:, default_trusted_profile: nil, user_data: nil)
    ...
    ##
    # @!method list_endpoint_gateways(name: nil, start: nil, limit: nil, resource_group_id: nil, lifecycle_state: nil, vpc_id: nil, vpc_crn: nil, vpc_name: nil, dns_resolution_binding_mode: nil)
    ...
    # @param vpc_name [String] Filters the collection to resources with a `vpc.name` property matching the exact
    #   specified name.
    # @param dns_resolution_binding_mode [Array[String]] Filters the collection to endpoint gateways with a `dns_resolution_binding_mode`
    #   property matching one of the specified comma-separated values.
    # @return [IBMCloudSdkCore::DetailedResponse] A `IBMCloudSdkCore::DetailedResponse` object representing the response.
    ...
    ##
    # @!method create_endpoint_gateway(target:, vpc:, dns_resolution_binding_mode: nil, ips: nil, name: nil, resource_group: nil, security_groups: nil)
    ...
    # @param dns_resolution_binding_mode [String] The DNS resolution binding mode to use for this endpoint gateway:
    ...
    ##
    # @!method list_endpoint_gateway_resource_bindings(endpoint_gateway_id:, start: nil, limit: nil)
    # List resource bindings for an endpoint gateway.
    # This request lists resource bindings for an endpoint gateway. A resource binding
    ...
    ##
    # @!method create_endpoint_gateway_resource_binding(endpoint_gateway_id:, target:, name: nil)
    # Create a resource binding for an endpoint gateway.
    # This request creates a new resource binding for an endpoint gateway from an
    ...
    #   connected topology.
    # @param endpoint_gateway_id [String] The endpoint gateway identifier.
    # @param target [EndpointGatewayResourceBindingTargetPrototype] The target to use for this resource binding.
    # @param name [String] The name for this resource binding. The name must not be used by another resource
    #   binding for the endpoint gateway. If unspecified, the name will be a hyphenated
    #   list of randomly-selected words.
    # @return [IBMCloudSdkCore::DetailedResponse] A `IBMCloudSdkCore::DetailedResponse` object representing the response.
    ...
    ##
    # @!method delete_endpoint_gateway_resource_binding(endpoint_gateway_id:, id:)
    # Delete a resource binding from an endpoint gateway.
    # This request deletes the specified resource binding from the specified endpoint
    #   gateway. This operation cannot be reversed.
    # @param endpoint_gateway_id [String] The endpoint gateway identifier.
    # @param id [String] The resource binding identifier.
    # @return [nil]
    ...
    ##
    # @!method get_endpoint_gateway_resource_binding(endpoint_gateway_id:, id:)
    # Retrieve an endpoint gateway resource binding.
    # This request retrieves a single endpoint gateway resource binding specified by the
    #   identifier in the URL.
    # @param endpoint_gateway_id [String] The endpoint gateway identifier.
    # @param id [String] The resource binding identifier.
    # @return [IBMCloudSdkCore::DetailedResponse] A `IBMCloudSdkCore::DetailedResponse` object representing the response.
    ...
    ##
    # @!method update_endpoint_gateway_resource_binding(endpoint_gateway_id:, id:, endpoint_gateway_resource_binding_patch:)
    # Update an endpoint gateway resource binding.
    # This request updates an endpoint gateway resource binding with the information in
    ...
    # @param endpoint_gateway_id [String] The endpoint gateway identifier.
    # @param id [String] The resource binding identifier.
    # @param endpoint_gateway_resource_binding_patch [Hash] The endpoint gateway resource binding patch.
    # @return [IBMCloudSdkCore::DetailedResponse] A `IBMCloudSdkCore::DetailedResponse` object representing the response.
    ...
    # @param name [String] Filters the collection to resources with a `name` property matching the exact
    #   specified name.
    # @param availability_class [String] Filters the collection to instances with an `availability.class` property matching
    #   the specified value.
    ...
    # @param instance_group_membership_instance_group_id [String] Filters the collection to instances with an
    #   `instance_group_membership.instance_group.id` property matching the specified
    #   instance group identifier.
    # @param instance_group_membership_instance_group_crn [String] Filters the collection to instances with an
    #   `instance_group_membership.instance_group.crn` property matching the specified
    #   instance group CRN.
    ...
    #   public address range in the region. Names starting with `ibm-` are reserved for
    #   provider-managed resources, and are not allowed. If unspecified, the name will be
    #   a hyphenated list of randomly-selected words.
    # @param resource_group [ResourceGroupIdentity] The resource group to use. If unspecified, the account's [default resource
    #   group](https://cloud.ibm.com/apidocs/resource-manager#introduction) will be used.
    ...
    ##
    # @!method delete_virtual_network_interfaces(id:, if_match: nil)
    ...
    ##
    # @!method update_virtual_network_interface(id:, virtual_network_interface_patch:, if_match: nil)
    ...
    ##
    # @!method list_volumes(start: nil, limit: nil, attachment_state: nil, encryption: nil, name: nil, operating_system_family: nil, operating_system_architecture: nil, storage_generation: nil, tag: nil, zone_name: nil)
    # List volumes.
    ...
    #   collection to resources which have no operating system or any operating system,
    #   respectively.
    # @param storage_generation [Fixnum] Filters the collection to volumes with a `storage_generation` property matching
    #   the specified value.
    # @param tag [String] Filters the collection to resources with an item in the `tags` property matching
    #   the exact specified tag.
    # @param zone_name [String] Filters the collection to resources with a `zone.name` property matching the exact
    ...
    ##
    # @!method list_volume_jobs(volume_id:, start: nil, limit: nil)
    # List jobs for a volume.
    # This request lists jobs for a volume. Each job represents an action performed on
    ...
    #   The jobs will be sorted by their `created_at` property values, with newest jobs
    #   first.
    # @param volume_id [String] The volume identifier.
    # @param start [String] A server-provided token determining what resource to start the page on.
    # @param limit [Fixnum] The number of resources to return on a page.
    # @return [IBMCloudSdkCore::DetailedResponse] A `IBMCloudSdkCore::DetailedResponse` object representing the response.
    ...
    ##
    # @!method create_volume_job(volume_id:, volume_job_prototype:, start: nil, limit: nil)
    # Create a job for a volume.
    # This request creates and queues a new job for the volume specified in the URL
    #   using the volume job prototype object.
    # @param volume_id [String] The volume identifier.
    # @param volume_job_prototype [VolumeJobPrototype] The volume job prototype object.
    # @param start [String] A server-provided token determining what resource to start the page on.
    # @param limit [Fixnum] The number of resources to return on a page.
    # @return [IBMCloudSdkCore::DetailedResponse] A `IBMCloudSdkCore::DetailedResponse` object representing the response.
    ...
    ##
    # @!method delete_volume_job(volume_id:, id:)
    # Delete a volume job.
    # This request deletes a volume job. This operation cannot be reversed. If the job
    #   has not completed, the job will be canceled, and the incomplete volume job will be
    #   deleted.
    # @param volume_id [String] The volume identifier.
    # @param id [String] The volume job identifier.
    # @return [nil]
    ...
    ##
    # @!method get_volume_job(volume_id:, id:)
    ...
    ##
    # @!method update_volume_job(volume_id:, id:, volume_job_patch:)
    # Update a volume job.
    # This request updates an volume job with the information in a provided volume job
    ...
    # @param volume_id [String] The volume identifier.
    # @param id [String] The volume job identifier.
    # @param volume_job_patch [Hash] The volume job patch.
    # @return [IBMCloudSdkCore::DetailedResponse] A `IBMCloudSdkCore::DetailedResponse` object representing the response.
    ...
    ##
    # @!method cancel_volume_job(volume_id:, id:)
    ...
    ##
    # @!method list_vpn_gateway_advertised_cidrs(vpn_gateway_id:)
    ...
    ##
    # @!method remove_vpn_gateway_advertised_cidr(vpn_gateway_id:, cidr:)
    ...
    ##
    # @!method check_vpn_gateway_advertised_cidr(vpn_gateway_id:, cidr:)
    # Check if the specified advertised CIDR exists on a VPN gateway.
    # This request succeeds if an advertised CIDR exists on the specified VPN gateway,
    #   and fails otherwise.
    #
    #   This request is only supported for route mode VPN gateways.
    # @param vpn_gateway_id [String] The VPN gateway identifier.
    ...
    ##
    # @!method add_vpn_gateway_advertised_cidr(vpn_gateway_id:, cidr:)
    # Set an advertised CIDR on a VPN gateway.
    # This request adds the specified CIDR to the specified VPN gateway advertised
    ...
    ##
    # @!method delete_vpn_gateway_connection(vpn_gateway_id:, id:, if_match: nil)
    ...
    ##
    # @!method update_vpn_gateway_connection(vpn_gateway_id:, id:, vpn_gateway_connection_patch:, if_match: nil)
    ...
    ##
    # @!method list_vpn_gateway_service_connections(vpn_gateway_id:, start: nil, limit: nil)
    # List VPN gateway service connections.
    # This request lists service connections on a VPN gateway. The VPN gateway service
    ...
    ##
    # @!method get_vpn_gateway_service_connection(vpn_gateway_id:, id:)
    # Retrieve a VPN gateway service connection.
    # This request retrieves VPN gateway service connection specified by the identifier
    #   in the URL.
    # @param vpn_gateway_id [String] The VPN gateway identifier.
    # @param id [String] The VPN gateway service connection identifier.
    # @return [IBMCloudSdkCore::DetailedResponse] A `IBMCloudSdkCore::DetailedResponse` object representing the response.
